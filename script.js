document.addEventListener('DOMContentLoaded', () => {
    ...
    const laws = [
        ...
        },
        {
            ...
            summary: "Too much circulation makes the price go down: The more you are seen and heard from, the more common you appear, and the less in control. If you are already established in a group, temporary withdrawal from it will make you more talked about, even more admired. You must learn when to leave. Create value through scarcity.",
            ...
            <div id="videos-view" class="view view-padding">
                ...
                <div class="video-list space-y-8">
                    ...
                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">The 48 Laws of Power by Robert Greene | Full Audiobook</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="http://googleusercontent.com/youtube.com/embed/oB6l8tqfA7U" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">Experience Robert Greene's seminal work, 'The 48 Laws of Power,' in its entirety with this full audiobook version. Dive deep into the strategies of power, influence, and manipulation across history, providing a comprehensive understanding of human behavior in various social and political contexts.</p>
                    </div>

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">Robert Greene On How To Master The Art of Seduction</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="http://googleusercontent.com/youtube.com/embed/8hB9U6JgYhA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">In this exclusive interview, Robert Greene delves into the intricacies of his controversial book, 'The Art of Seduction.' He shares insights on the psychological principles behind attraction, desire, and persuasion, discussing how historical figures mastered these arts and how they can be applied in modern relationships and social dynamics.</p>
                    </div>

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">48 Laws of Power by Robert Greene Book Review</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="http://googleusercontent.com/youtube.com/embed/P7s2RzRzY7c" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
