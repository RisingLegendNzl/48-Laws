            ...
            <div id="videos-view" class="view view-padding">
                ...
                <div class="video-list space-y-8">
                    ...
                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">The 48 Laws of Power by Robert Greene (Animated)</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="https://m.youtube.com/watch?v=Su36tpkuo1I&pp=ygUQNDggbGF3cyBvZiBwb3dlcg%3D%3D" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">A clear, concise, and animated summary of all 48 laws, perfect for a quick overview.</p>
                    </div>

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">Robert Greene on the Laws of Power</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="https://m.youtube.com/watch?v=670ZGMBjrPI&pp=ygUQNDggbGF3cyBvZiBwb3dlcg%3D%3D" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">An in-depth interview with author Robert Greene, where he discusses the philosophy behind the book and its real-world application.</p>
                    </div>

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">The Dangers of The 48 Laws of Power (Critique)</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="https://m.youtube.com/watch?v=Ke5kFc7U1h8&pp=ygUQNDggbGF3cyBvZiBwb3dlcg%3D%3D" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">A thoughtful critique exploring the potential dangers and ethical pitfalls of applying the laws without caution.</p>
                    </div>

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">Related Video 4</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="https://m.youtube.com/watch?v=6r-e9BJtusk&pp=ygUQNDggbGF3cyBvZiBwb3dlcg%3D%3D" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">An additional video related to the themes of the book.</p>
                    </div>

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">Related Video 5</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="https://m.youtube.com/watch?v=atBIcQCQ3cM&pp=ygUZNDggbGF3cyBvZiBwb3dlciB3b3J0aCBpdA%3D%3D" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">Another video exploring the content of the book from a different perspective.</p>
                    </div>
