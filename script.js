document.addEventListener('DOMContentLoaded', () => {
    ...
    const laws = [
        ...
        },
        {
            ...
            criticism: "While appealing to self-interest is often effective, it ignores the power of altruism, friendship, and a sense of duty. People often do things for others without expecting anything in return. Assuming everyone is purely self-interested is a narrow view of human nature."
        },
        {
        ...
        },
        {
            ...
            criticism: "This law promotes a cynical view of generosity. People often do many things for others without expecting anything in return. While it's wise to be cautious, assuming every free offer is a trap can cause you to miss out on genuine opportunities and acts of kindness."
        },
        {
    ...
    const views = {
        ...
        videos: `
            <div id="videos-view" class="view view-padding">
                <h2 class="text-2xl font-bold text-white mb-6">Video Insights</h2>
                <div class="video-list space-y-8">

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">The 48 Laws of Power in Under 30 Minutes</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="https://youtu.be/Su36tpkuo1I?si=vHRXG6xd3TNn_bB_" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">A concise summary of all 48 laws, perfect for a quick overview.</p>
                    </div>

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">The 48 Laws of Power Summarized in Under 8 Minutes by Robert Greene</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="https://youtu.be/Ke5kFc7U1h8?si=QRofzkghWXjGsnfk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">In this video, Robert Greene, the author of 'The 48 Laws of Power,' explains why people should read his book. He emphasizes that understanding power dynamics is crucial for navigating life and avoiding painful mistakes. Greene shares that the book offers a straightforward look at the world and its power structures, without sugarcoating reality. He highlights that the laws are not just for offensive tactics but also for defense, helping readers recognize and protect themselves from manipulative individuals. Greene also discusses how he has applied some of these laws in his own life, such as making himself irreplaceable and acting with boldness. He concludes by stressing the book's importance in preventing common pitfalls like outshining superiors or trusting the wrong people.</p>
                    </div>

                    <div class="video-card bg-gray-900 p-4 rounded-md border border-gray-700">
                        <h3 class="text-lg font-semibold text-white mb-2">48 Laws of Power by Robert Greene Book Review</h3>
                        <div class="video-container rounded-md overflow-hidden mb-2">
                            <iframe src="https://youtu.be/atBIcQCQ3cM?si=lJapz0N6D6cAVV5W" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <p class="text-sm text-gray-400">The video is a review of Robert Greene's book, 'The 48 Laws of Power.' The review describes the book as a bold and provocative guide to understanding power dynamics in human interactions. It highlights that the book draws from history, philosophy, and real-world examples to present 48 laws on how power is gained, maintained, and lost. The review notes the book's unapologetic approach to power, focusing on effectiveness rather than moral judgment. It mentions specific laws like 'conceal your intentions' and 'always say less than necessary' as examples of strategic insights for competitive environments. The review praises Greene's ability to present complex ideas in an engaging way, supported by historical anecdotes. While acknowledging that some may find the book's tone ruthless, it emphasizes the thought-provoking nature of its insights and that Greene focuses on understanding power dynamics. The review concludes by calling 'The 48 Laws of Power' an essential read for those interested in strategy, influence, or personal growth, with relevant lessons for navigating human ambition and relationships.</p>
                    </div>
